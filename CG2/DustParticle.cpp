...
void DustParticle::Initialize(ViewProjection* viewProjection, XMMATRIX* matProjection, Vector3 initPos)
{
...
void DustParticle::Update(Vector3 initPos)
{
	move = { 0,0,0 };
...
void DustParticle::SetScale(Vector3 scale)
{
